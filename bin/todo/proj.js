...
pico.define('cfg/proj.json','[["p/View","view",[["tasks","models",[["reload","bool",true]]],["activeTasks","view",[["options","map",{"el":".__ ul#active"}],["tasks","ref","tasks"],["activeTask","view",[["options","map",{"tagName":"li"}],["task","model","tasks",0]]]]],["addTask","view",[["options","map",{"el":".__ #input"}],["html","file","addTask.html"],["tasks","ref","tasks"]]],["completedTasks","view",[["options","map",{"el":".__ ul#completed"}],["tasks","ref","tasks"],["completedTask","view",[["options","map",{"tagName":"li"}],["task","model","tasks",0]]]]]]]]')
...
pico.define('activeTasks',function anonymous(exports,require,module,define,inherit,pico
/*``*/) {
"use strict";
...
return {
	...
	create:function(deps, params){
		...
		deps.tasks.list(function(err, models){
			if (err) return console.error(err)
			models.filter( m => m.state ).forEach( m => renderTasks(this, m) )
		})
	}
}
//# sourceURL=activeTasks
})
pico.define('activeTask',function anonymous(exports,require,module,define,inherit,pico
/*``*/) {
"use strict";
return {
	deps:{
...
//# sourceURL=activeTask
})
pico.define('addTask',function anonymous(exports,require,module,define,inherit,pico
/*``*/) {
"use strict";
return {
	deps:{
...
pico.define('addTask.html','<input type="text" placeholder="Type here…">\n<button>Add</button>\n')
pico.define('completedTasks',function anonymous(exports,require,module,define,inherit,pico
/*``*/) {
"use strict";
return {
	deps:{
...
//# sourceURL=completedTasks
})
pico.define('completedTask',function anonymous(exports,require,module,define,inherit,pico
/*``*/) {
"use strict";
return {
}
//# sourceURL=completedTask
})
